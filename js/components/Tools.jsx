  ...
  render () {
    return <div className='mdl-grid content' id='tools'>
      ...
      <div className='mdl-cell mdl-cell--2-offset-desktop mdl-cell--8-col'>
        { this.props.tools.map((t) => <a className='mdl-button mdl-js-button mdl-button--raised mdl-button--fab mdl-js-ripple-effect' key={t.url} href={t.url} target='_blank'><Icon icon={t.icon} name={t.hasOwnProperty('name') ? t.name : null} /></a>)}
      </div>
    </div>
  }
}
